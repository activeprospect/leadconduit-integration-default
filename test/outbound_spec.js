...
describe('Outbound Request', function() {
  ...
  it('should encode content sent via get as querystring', function() {
  ...
  it('should merge content sent via get over querystring', function() {
  ...
  it('should handle null variable', function() {
  ...
  it('should handle undefined variable', function() {
  ...
  it('should encode content sent as post', function() {
  ...
  it('should handle dot notation vars', function() {
  ...
  it('should handle deeply nested vars', function() {
    const { url } = integration.request({url: 'http://externalservice', method: 'get', lead: { deeply: { nested: { var: 'Hola' } } }});
    assert.equal(url, 'http://externalservice/?deeply.nested.var=Hola&price=0');
  });


  it('should handle new format custom fields', function() {
  ...
  it('should overwrite standard fields with custom fields of the same name', function() {
...
describe('Outbound Validate', function() {

  it('should require valid default_outcome', function() {
  ...
  it('should require url variable', function() {
  ...
  it('should require valid url variable', function() {
    const vars = variables();
    vars.url = 'donkeykong';
...
describe('Outbound Response', function() {
  ...
  it('should default outcome to "error"', function() {
  ...
  it('should default outcome to specified default', function() {
  ...
  it('should preserve existing reason even if outcome defaults to "error"', function() {
  ...
  it('should parse XML response', function() {
  ...
  it('should handle poorly formed XML response', function() {
  ...
  it('should use handler "message" as error reason', function() {
    const expected = {
      outcome: 'error',
